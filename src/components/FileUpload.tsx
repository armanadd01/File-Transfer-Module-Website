...
const FileUpload = forwardRef<FileUploadHandle, FileUploadProps>(({
  ...
  useEffect(() => {
    const dropzone = new Dropzone('#upload-zone', {
      ...
      dictDefaultMessage: '<div class="flex flex-col items-center justify-center gap-4"><svg class="w-10 h-10 text-gray-400 dark:text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path></svg><div class="text-lg text-center font-medium text-gray-900 dark:text-gray-100">Drop files to upload<div class="text-sm text-gray-500 dark:text-gray-400">or click to select files</div></div></div>'
    });
